...
<section class="contact-wrap sec-space-bottom">
    <div class="container rel-div pt-50">
        ...
        <div class="pt-50 col-md-8 col-md-offset-2">
            <h3 class="fsz-25 text-center"><span class="light-font">Contact </span> <strong>Thrift Fashion </strong> <span class="light-font"> for Queries </span></h3>

            <div class="contact-form pt-50">
                <form class="contact-form row" id="contact-form" method="post"
                    action="{{url('dashboard/contact/store')}}">
                    @csrf
                    ...
                    <div class="form-group col-sm-4">
                        <input class="form-control" placeholder="Email" name="email"
                            value="@if(Auth::user()) {{Auth::user()->email}}@endif" id="Email" required="" type="email">
                        <span class="text-danger">@error('email'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group col-sm-4">
                        <input class="form-control" placeholder="Phone" name="contact"
                            value="@if(Auth::user()) {{Auth::user()->contact}}@endif" id="Phone" type="text">
